...
Scenario: Basic enrollment with multiple V2 configuration types
    ...
    | StorageConfiguration__mycontainer | blobaccount  | blobcontainer |
    ...
    | StorageConfiguration__mydb__mycontainer | cosmosaccount | db            | spongs         |
    ...
    | StorageConfiguration__mytable | tableaccount | wibbles |
