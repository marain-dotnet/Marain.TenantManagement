...
namespace Marain.TenantManagement.Specs.Features.TenantManagement
{
    ...
    [NUnit.Framework.TestFixtureAttribute(TestName="Adding a new Service tenant")]
    [NUnit.Framework.DescriptionAttribute("\tIn order to enable a Marain service for enrollment\r\n\tAs an administrator\r\n\tI wan" +
        "t to create a new service tenant for the service")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Create new service tenant")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Create a new service tenant without supplying a manifest")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Create new service tenant when the tenancy provider has not been initialised")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Create a new service tenant where at least one of the services in the list of dep" +
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Create a new service tenant where the name in the manifest is already in use")]
