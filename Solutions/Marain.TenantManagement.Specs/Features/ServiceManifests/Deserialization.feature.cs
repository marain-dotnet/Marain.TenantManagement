...
namespace Marain.TenantManagement.Specs.Features.ServiceManifests
{
    ...
    [NUnit.Framework.TestFixtureAttribute(TestName="Service manifest deserialization")]
    [NUnit.Framework.DescriptionAttribute("\tIn order to provide a description of a service\r\n\tAs an engineer\r\n\tI want to be a" +
        "ble to supply a service manifest as Json")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Simple manifest with no dependencies or configuration")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Manifest with dependencies")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Manifest with a configuration item")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Manifest with multiple configuration items")]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute(TestName="Manifest with a configuration item that has an unknown content type")]
